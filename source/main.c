...
int main()
{
	...
	while (end != 1)
	{
		...
		case '3':
			printf("你以為能到達終點的路不一定是真的路，偷偷告訴你，在迷宮中有神奇的傳送門!\n想要一步登天，去牆角蹲吧!!!\n小提示：走越少步能獲得越多*喔!\n\n");
			printf("\n開始挑戰：Enter     回到主選單：Esc\n");
